...
namespace PCMonitor {
    ...
    internal sealed partial class JsonTextReaderRunner : FATextReaderRunner {
        private FAMatch _BlockEnd12(int position, int line, int column) {
        q0:
            // [\*]
            if ((this.current == 42)) {
                this.Advance();
        ...
        q1:
            ...
            goto errorout;
        q2:
            return FAMatch.Create(12, this.capture.ToString(), position, line, column);
        errorout:
            if ((this.current == -1)) {
        ...
        q20:
            ...
            return FAMatch.Create(11, this.capture.ToString(), p, l, c);
        q21:
        ...
        public const int CommentLine = 11;
